...
export default function Overlay({ containerRef }) {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center w-full h-full max-w-7xl mx-auto px-6" style={{ height: '1500vh' }}>
            {/* Sticky Container for overlays */}
            <div className="sticky top-0 h-screen w-full flex flex-col justify-center">
                ...
                >
                    <div className="max-w-xl">
                        ...
                        <p className="text-lg font-mono text-gray-400 border-l-2 border-blue-500 pl-4">
                ...
                >
                    <div className="max-w-xl">
                        <h2 className="text-4xl md:text-6xl font-bold tracking-tighter mb-4 text-white">
                            Fractionalized.<br />
                            <span className="text-blue-500">Sovereign.</span><br />
                            Secure.
                        </h2>
                        <div className="flex justify-end gap-2 text-xs font-mono text-yellow-500">
                ...
                >
                    <div className="p-8 border border-white/10 bg-black/80 backdrop-blur-md rounded-lg text-center">
                        <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-blue-500">
                            BondFi
                        </h1>
