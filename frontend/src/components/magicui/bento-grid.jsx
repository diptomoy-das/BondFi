...
export const BentoCard = ({
    ...
    >
        ...
        <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
            ...
            <p className="max-w-lg text-muted-foreground font-mono text-sm">{description}</p>
        </div>
        ...
        >
            <Button variant="ghost" asChild size="sm" className="pointer-events-auto text-primary hover:text-primary/80">
                <a href={href}>
                    {cta}
        ...
        <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-black/[.03] group-hover:dark:bg-primary/[.02]" />
    </div>
);